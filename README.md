...
🎯 Task
Conduct a comparable company analysis (Comps) of TCS and Wipro for FY 2024–2025 to evaluate:
...
Built structured financial models
...
Market valuation data (~Apr 2025)
Data Normalization
Currency alignment (USD vs INR)
Comparable metric structuring
Financial Analysis
Income statement breakdown
Cost structure (employee, SG&A, etc.)
Margin analysis (EBIT, EBITDA, Net)
Valuation Modeling
...
Wipro showed declining growth (-8.7%), indicating pressure
💰 Profitability
TCS maintained industry-leading margins (~24% EBIT, ~19% net)
Wipro margins declined significantly due to rising costs
⚡ Efficiency
TCS demonstrated strong cost control and SG&A efficiency gains
Revenue per employee improved for TCS, declined for Wipro
📊 Valuation
TCS trades at a premium vs sector median
Wipro trades at lower multiples due to weaker performance
🧠 Strategic Insight
